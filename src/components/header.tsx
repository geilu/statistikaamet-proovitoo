    ...
    return (
        <div className="bg-black w-full h-[2.5em] flex flex-row justify-between items-center px-[3.5em] text-white">
            ...
            <div id="header-center" className="w-full flex flex-row justify-center gap-[2em]">
                ...
                <a className={aStyle}
                   href="https://x.com/eestistatistika" target="_blank" rel="noopener noreferrer">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        className="fill-white hover:fill-black">
                ...
                <a className={aStyle}
                   href="https://www.linkedin.com/company/statistikaamet-statistics-estonia/" target="_blank" rel="noopener noreferrer">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        className="fill-white hover:fill-black">
                ...
                <a className={aStyle}
                   href="https://www.youtube.com/user/Statistikaamet/featured" target="_blank" rel="noopener noreferrer">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        className="fill-white hover:fill-black">
                ...
                <a className={aStyle}
                   href="https://www.instagram.com/eesti_statistika/" target="_blank" rel="noopener noreferrer">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        className="fill-white hover:fill-black">
